...
========================================
Time/call-count limit checks (`check_limits`, `_stop`), the dashboard "how much is
left" view (`remaining`), and cumulative context-window pressure tracking
(`charge_context`, `get_context_pressure`).
...
def check_limits(cost_summary: dict) -> str | None:
    """
    Check all hard limits against current time/call data.
